        ...
        <div className="mt-10 md:mt-16 lg:mt-20">
          {faqs.map(({ question, answer }, faqIndex) => (
            ...
            >
              ...
              <div className={twMerge("flex justify-between items-center gap-4 transition-all duration-700 group-hover/faq:lg:px-8", faqIndex === selectedIndex && "lg:px-8")}>
                <div className="text-2xl md:text-3xl lg:text-4xl">
                  {question}
                </div>
                <div
                  className={twMerge(
                    "inline-flex items-center justify-center border border-stone-400 size-11 rounded-full shrink-0 transition duration-300 bg-stone-200",
