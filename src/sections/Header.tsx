        ...
        <nav className="mt-20 flex flex-col">
          {navItems.map(({ label, href }) => (
            <a
              href={href}
              key={label}
              className="text-stone-200 py-8 border-t last:border-b border-stone-800 group/nav-item relative isolate"
          ...
          <div className="flex justify-end items-center h-20">
            <div className="flex items-center gap-4">
              <div
                ...
                className="size-11 border border-stone-400 rounded-full inline-flex justify-center items-center bg-stone-200"
              >
                <svg
                  width="24"
                  height="24"
