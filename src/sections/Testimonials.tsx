...
const Testimonials: FC = () => {
  ...
  return (
    <section className="section">
      <h2 className="flex flex-col text-4xl md:text-7xl lg:text-8xl overflow-hidden tracking-tighter">
      ...
      <div className="container">
        ...
        <div className="flex gap-4 mt-6 lg:mt-10">
          <button className="border border-stone-400 size-11 inline-flex justify-center items-center rounded-full">
            <svg
